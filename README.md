...
==================================================================================================================================================
 ...
 Project Overview
The Theatre Management System is a MySQL database project designed to manage the data of the customers, bookings made, shows alloted and seats occupied of a movie theatre.
...
- One booking can contain many shows.
- Many shows can be associated with one seat.
- Each booking belongs to exactly one customer, each show entry in a booking is linked to exactly one booking
